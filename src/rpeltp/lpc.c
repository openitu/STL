...
static void Quantization_and_coding P1 ((LAR), register word * LAR      /* [0..7] IN/OUT */
  ...
  /* This procedure needs four tables; the following equations give the optimum scaling for the constants: A[0..7] = integer( real_A[0..7] * 1024 ) B[0..7] = integer( real_B[0..7] * 512 ) MAC[0..7] = maximum of the LARc[0..7] MIC[0..7] = minimum of the LARc[0..7] */
