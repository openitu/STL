...
void initTables () {
  ...
  int numDecisionVals;          /* number of entries in R0 and rc quant tables */
  int nb;                       /* used to create table of sst coefs for FLATV() */
  int K_BITS[11];               /* bit allocations for refl. coefs, read from file */
