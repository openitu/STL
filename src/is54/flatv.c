...
void FLATV () {
  ...
  FTYPE temp;                   /* temporarily holds denominator of reflection coef */
  FTYPE temp2;                  /* temporarily holds numerator of reflection coef */
  FTYPE *kPtr;                  /* points to current reflection coef in buffer */
  FTYPE termf;                  /* temporary f[i][k] term in matrix update loop */
  FTYPE termb;                  /* temporary b[i][k] term in matrix update loop */
  FTYPE termc1;                 /* temporary c[i][k] term in matrix update loop */
  FTYPE termc2;                 /* temporary c[k][i] term in matrix update loop */
  FTYPE term;                   /* temporary rj(~ + ~) term in matrix update loop */
