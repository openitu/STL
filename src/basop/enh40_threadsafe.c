...
/* 
Make thread-safe and optimize for codec floating-point source. Modifications can be expanded or edited for other ITU and 3GPP ETSI codecs, as needed
 ...
 *****************************************************************************/
  ...
  #include "options.h"  /* either the Makefile or a include file such as options.h or similar should contain definitions, as applicable, for USE_BASOPS_INLINE, EXCLUDE_BASOPS_NOT_USED, USE_BASOPS_OVERFLOW_GLOBAL_VAR, USE_BASOPS_CARRY_GLOBAL_VAR, and USE_BASOPS_EXIT, JHB Mar 2023 */
#endif
...
#if defined(USE_BASOPS_THREADSAFE) && defined(_MSC_VER) && (_MSC_VER <= 1200)
