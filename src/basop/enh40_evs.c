...
/* 
Make thread-safe and optimize for EVS codec floating-point use. Modifications can be expanded or edited for other ITU and 3GPP ETSI codecs, as needed
...
Revision History
  ...
  Sep 2022 - Mar 2023 JHB, implement mods for 3GPP EVS build:
                -if _EVS_ defined in Makefile (a) options.h should contain basop build control defines "USE_BASOPS_xxx" (b) EVS specific codes are enabled
                -enable/disable Overflow and Carry global variables with USE_BASOPS_OVERFLOW_GLOBAL_VAR and USE_BASOPS_CARRY_GLOBAL_VAR
                -no indentation/formatting mods to STL 2017 file outside of EVS related changes
                -note that MSC_VER sections were added by EVS authors, not in original STL file. These remain unmodified by Signalogic
  Mar 2023 JHB, test with EVS build mods in basop32.c and basop32.h, improve comments
*/
...
#if defined(_EVS_) && defined(_MSC_VER) && (_MSC_VER <= 1200)
  ...
  if (var2 < 0) {
    ...
    for (; var2 > 0; var2--) {
      ...
      if (L40_var_out > 0x003fffffffffLL) {
        ...
        #if defined(USE_BASOPS_OVERFLOW_GLOBAL_VAR) && defined(USE_BASOPS_EXIT)  /* L40_xxxFLOW_OCCURED macros in enh40.h set Overflow and exit */
        ...
        L40_var_out = 0x003fffffffffLL;  /* otherwise saturate and proceed, JHB Mar 2023 */
        break;
      }
        ...
        L40_var_out = L40_constant;  /* otherwise saturate and proceed, JHB Mar 2023 */
        break;
      }
 ...
 *
 *****************************************************************************/
#ifndef _EVS_  /* Remove unused function that sets global Overflow flag - CJ MAR2017 */
