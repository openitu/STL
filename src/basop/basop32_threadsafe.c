...
/* 
Make thread-safe and optimize for codec floating-point source. Initially tested with EVS and AMR-WB, but modifications can be expanded or edited for other ITU and 3GPP ETSI codecs, as needed
...
For reference, here are 3GPP EVS floating-point source files that reference basop32 fixed-point functions, Signalogic Mar 2023
...
/*___________________________________________________________________________
 ...
 |___________________________________________________________________________|
*/
#ifdef _EVS_  /* _EVS_ can be defined in Makefile when building 3GPP EVS codec */
...
/*___________________________________________________________________________
 ...
 |___________________________________________________________________________|
*/
#ifndef USE_BASOPS_THREADSAFE  /* declared as static inline in basop32.h, JHB Mar 2023 */
...
Word16 div_l (Word32 L_num, Word16 den) {
  ...
  if ((L_num < (Word32) 0) || (den < (Word16) 0)) {
    ...
    exit(0);
    #else
    fprintf(stderr, "Division error in div_l in basop32, L_num = %d den = %d \n", L_num, den);
