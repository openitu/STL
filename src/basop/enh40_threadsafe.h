...
Revision History
  ...
  Sep 2022 - Mar 2023 JHB, implement mods for codec builds:
                ...
                -note that MSC_VER section edits were by EVS authors, not in original STL file. These remain unmodified by Signalogic for EVS compatibility
...
#else
  #define MAX_40 (0x0000007fffffffffLL)
  #define MIN_40 (0xffffff8000000000LL)
 ...
 *  the application will exit. (Note - with 2022-2023 mods, it will not exit unless USE_BASOPS_EXIT is defined)
 *
 *****************************************************************************/
