...
int main (int argc, char *argv[]) {
  ...
  /* Check options: -q operate quietly -delay n n is the number of samples to delay (default: 43) -tail add samples to the end of the file, rather than the beginning -law [l|A|u] coding law (default: linear). The default value for linear samples is 0, for A-law is 0xD5 (0x80 without bit inversion), and for u-law is 0xFF. -dec z Uses the specified decimal value z. Overrides -law! -hex z Uses the specified hexadecimal value z. Overrides -law! -file fff Uses the provided file fff as the delay -help Displays usage */
  if (argc < 2)
    display_usage ();
  else {
