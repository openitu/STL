...
int /* returns 0 if ill-conditioned, else 1 */ g728fp_autocor (
                                                                int lpc,        /* filter order */
                                                                int nfrsz,      /* # of new samples (frame size) */
                                                                int nonr,       /* number of non-recursive samples */
                                                                Nshift iatt,    /* right shift factors for attenuation 2 for 50th-order LPC and log-gain predictor 1 for weighting filter */
