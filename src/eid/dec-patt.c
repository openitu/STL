...
int main (int argc, char *argv[]) {
  ...
  FIND_PAR_L (3, "_Decimation factor .......................: ", dec_fac, dec_fac);
  ...
  save_patt = ep_format == byte ? save_byte : (ep_format == g192 ? save_g192 : save_bit);
  ...
  fprintf (stderr, "# Master EP %s...........: %f %%\n", ep_type == BER ? "Bit error rate ..." : "Frame erasure rate", 100.0 * disturb_master / proc_master);
  fprintf (stderr, "# Output EP - Distorted %s.......... : %.0f \n", ep_type == BER ? "bits .." : "frames ", disturb_new);
  fprintf (stderr, "# Output EP %s...........: %f %%\n", ep_type == BER ? "Bit error rate ..." : "Frame erasure rate", 100.0 * disturb_new / proc_new);
