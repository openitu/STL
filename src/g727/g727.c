...
Int8 g727_sync ARGS ((Int8 in, Int8 sp, Int16 dlnx, short law, Int8 ds, short rate));
...
void g727_accum (Int16 * se, Int16 * sez, Int16 wa1, Int16 wa2, Int16 wb1, Int16 wb2, Int16 wb3, Int16 wb4, Int16 wb5, Int16 wb6) {
  Int16 sezi = (((((((((wb1 + wb2) & 65535) + wb3) & 65535) + wb4) & 65535) + wb5) & 65535) + wb6) & 65535;
...
Int16 g727_fmult (Int16 an, Int16 srn) {
  ...
  wanmag = (wanexp <= 26) ? (((Int16) wanmant << 7) >> (26 - wanexp)) : ((((Int16) wanmant << 7) << (wanexp - 26)) & 32767);
...
Int16 g727_limc (Int16 a2t) {
  ...
  return (32768 <= a2t && a2t <= a2ll) ? a2ll : ((a2ul <= a2t && a2t <= 32767) ? a2ul : a2t);
}
...
Int16 g727_limd (Int16 a1t, Int16 a2p) {
  ...
  return (32768 <= a1t && a1t <= a1ll) ? a1ll : ((a1ul <= a1t && a1t <= 32767) ? a1ul : a1t);
}
...
Int16 g727_upa2 (g727_aprsc_state *st, Int8 pk0, Int8 sigpk) {
  ...
  if (a1s == 0)
    ...
    fa1 = (st->a1 >= 57345) ? (((Int32) st->a1 << 2) & 131071) : (24577UL << 2);
  else
    assert (0);
