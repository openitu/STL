...
Additional filters (SHQ2 and SHQ3 for super-high-quality for rate-change factors 2 and 3, respectively) with more taps and smaller transition band are also provided; their frequency responses are given in figures \ref{shq-frq-1-2} and \ref{shq-frq-1-3}.
...
High-pass filters with 50 Hz cutoff frequency for the 32 and 48 kHz sampling rates (HP50\_32K and HP50\_48K) are also provided. Their frequency response is given in figures \ref{hp50-32k} and \ref{hp50-48k}.
...
\begin{figure}[hbtp]
  \begin{center}
   ...
   (a) 50Hz high-pass filter operating at 32 kHz.
    ...
    \\
   (b) 50Hz high-pass filter operating at 32 kHz..
